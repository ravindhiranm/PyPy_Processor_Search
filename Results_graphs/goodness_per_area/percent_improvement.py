...
t1=8
ax2 = ax1.twinx()
ax2.plot(power_budget, hocmp_value, color=set2[t1], label="HoCMP", marker = markers.next(), markersize=4, linewidth=0.5)
ax2.plot(power_budget, hecmp_value, color=set2[t1], label="HeCMP", marker = markers.next(), markersize=4, linewidth=0.5)
ax2.set_ylabel('BIPS^2/W*mm^2', color=set2[t1])
##ax2.set_ylabel('Speedup/mm^2', color=set2[t1])
