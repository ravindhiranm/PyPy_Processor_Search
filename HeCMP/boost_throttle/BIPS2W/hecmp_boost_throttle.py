...
class core_config():
    def __init__(self):
        ...
        self.app_bips2w=defaultdict(list)
...
def evaluate(total_cores, core, area_constraint, power_constraint):
    ...
    for p in workloads:
        ...
        for j in permute:
            ...
            core0_goodness_list = core[0].get_bips2w(wl1)
            core1_goodness_list = core[1].get_bips2w(wl2)
            core2_goodness_list = core[2].get_bips2w(wl3)
            core3_goodness_list = core[3].get_bips2w(wl4)
